...
var v = (r, e, n, t) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let a7 of F(e))
      !w.call(r, a7) && a7 !== n && u(r, a7, { get: () => e[a7], enumerable: !(t = B(e, a7)) || t.enumerable });
  return r;
};
  ...
  Object.defineProperty(T, "__esModule", { value: true }), T.isEqual = function() {
    ...
    return function(t, a7) {
      return function i(o, s7, p) {
        ...
        if (o == null || s7 == null)
          return false;
        if (p.indexOf(o) > -1 && p.indexOf(s7) > -1)
          return true;
        ...
        switch (c.slice(8, -1)) {
          ...
          case "Map":
            ...
            do
              if (!i((d = g7.next()).value, y.next().value, p))
                return false;
            while (!d.done);
            return true;
          case "ArrayBuffer":
          ...
          case "Arguments":
          case "Array":
            if (o.length != s7.length)
              return false;
            for (d = 0; d < o.length; d++)
              if ((d in o || d in s7) && (d in o != d in s7 || !i(o[d], s7[d], p)))
                return false;
            return true;
          case "Object":
            return i(e(o), e(s7), p);
...
var k = (r, e) => {
  ...
  if (S([n, t, a7, i]) > 1)
    throw new Error(`Invalid conditional test ${JSON.stringify({ exists: n, eq: t, neq: a7 })}`);
  if (typeof t < "u")
    return (0, l.isEqual)(e, t);
  if (typeof a7 < "u")
    return !(0, l.isEqual)(e, a7);
  if (typeof n < "u") {
    let s7 = typeof e < "u";
    return n ? s7 : !s7;
  }
...
var P = (r, e, n) => {
  ...
  if (S([t, a7]) !== 1)
    throw new Error(`Invalid conditional value ${JSON.stringify({ arg: t, global: a7 })}`);
  let i = t ? e[t] : n[a7];
  return k(r.if, i);
};
...
var ea = _((vp, bs) => {
  (function(e) {
    ...
    return a(function n(o, i, l7) {
      ...
      a(u7, "s");
      for (var c = typeof Zo == "function" && Zo, p = 0; p < l7.length; p++)
        u7(l7[p]);
      return u7;
    }, "e")({ 1: [function(n, o, i) {
...
function sm(e, t) {
  var r;
  if (e.type === "text" || e.type === "comment" || Gi(e) || e.type === "yaml" || e.type === "toml")
    return null;
  if (e.type === "attribute" && delete t.value, e.type === "docType" && delete t.value, e.type === "angularControlFlowBlock" && (r = e.parameters) != null && r.children)
    for (let n of t.parameters.children)
      aC.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
...
function zC(e, t) {
  ...
  if (e.type === "element" && e.namespace === "svg")
    if ($C(e, (o) => o.fullName === "svg:foreignObject"))
      n = true;
    else
...
async function qC(e, t) {
  let r = [];
  for (let [n, o] of e.split(Cm).entries())
    if (n % 2 === 0)
      r.push(ot(o));
    else
      try {
...
function XC(e, t) {
  ...
  let o = or(r);
  if (/^i18n(?:-.+)?$/u.test(n))
    return () => Xi(lm(Dm(r, o.trim())), !o.includes("@@"));
  if (Cm.test(o))
    return (i) => qC(o, i);
}
function KC(e, t) {
...
function nE(e) {
  ...
  function h4() {
    for (p(JC), o = "", i = "in descriptor"; ; ) {
      if (l7 = e.charAt(u7), i === "in descriptor")
        if (R5(l7))
        ...
        if (l7 === ")")
          o += l7, i = "in descriptor";
        else if (l7 === "") {
          n.push(o), f();
          return;
        } else
          o += l7;
      else if (i === "after descriptor" && !R5(l7))
        if (l7 === "") {
          f();
          return;
        } else
          i = "in descriptor", u7 -= 1;
      u7 += 1;
    }
  }
  a(h4, "f");
  function f() {
    ...
    for (y = 0; y < n.length; y++)
      D = n[y], x5 = D[D.length - 1], C4 = D.substring(0, D.length - 1), E7 = parseInt(C4, 10), S7 = parseFloat(C4), A5.test(C4) && x5 === "w" ? ((b || m) && (v6 = true), E7 === 0 ? v6 = true : b = E7) : rE.test(C4) && x5 === "x" ? ((b || m || g7) && (v6 = true), S7 < 0 ? v6 = true : m = S7) : A5.test(C4) && x5 === "h" ? ((g7 || m) && (v6 = true), E7 === 0 ? v6 = true : g7 = E7) : v6 = true;
    if (!v6)
      w6.source = { value: r, startOffset: c }, b && (w6.width = { value: b }), m && (w6.density = { value: m }), g7 && (w6.height = { value: g7 }), d.push(w6);
    else
      throw new Error(`Invalid srcset descriptor found in "${e}" at "${D}".`);
  }
  a(f, "d");
}
function aE(e) {
...
function uE(e, t) {
  ...
  if (r.fullName === "style" && !t.parentParser && !n.includes("{{"))
    return async (o) => Xi(await o(n, { parser: "css", __isHTMLStyleAttribute: true }));
}
function cE(e, t) {
  let { root: r } = e;
...
function gE(e, t) {
  ...
  if (n === "v-for")
    return hE;
  if (n === "generic" && xm(r.parent, t))
    return pE;
  let o = or(r), i = mc(e, t);
  if (jC(r) || VC(r, t))
    return (l7) => dE(o, l7, { parseWithTs: i });
  if (n.startsWith("@") || n.startsWith("v-on:"))
    return (l7) => vE(o, l7, { parseWithTs: i });
  if (n.startsWith(":") || n.startsWith("v-bind:"))
    return (l7) => wE(o, l7, { parseWithTs: i });
  if (n.startsWith("v-"))
    return (l7) => Sm(o, l7, { parseWithTs: i });
}
...
function DE(e) {
  return async (t, r, n, o) => {
    ...
    if (i)
      return i = pc(i, (l7) => typeof l7 == "string" ? Oe(false, l7, '"', "&quot;") : l7), [n.node.rawName, '="', ue(i), '"'];
  };
}
function CE(e) {
  ...
  return e.map((i, l7) => {
    ...
    if (Ye(u7)) {
      if (u7.prev && Ye(u7.prev)) {
        let b = ki(u7.prev, u7);
        if (b)
          return Fi(u7.prev) ? [Q, Q, fa(i, t, r)] : [b, fa(i, t, r)];
      }
      return fa(i, t, r);
    }
...
function YE(e, t, r) {
  let { node: n } = e;
  if (cm(n, t))
    return [Mr(n, t), ue(Qu(e, t, r)), ot(km(n, t)), ...Ju(n, t), Ir(n, t)];
...
function pS(e, t) {
  e.walk((r) => {
    ...
    if (n) {
      ...
      for (let o of n)
        o.isLeadingSpaceSensitive = EC(o, t), o.isTrailingSpaceSensitive = SC(o, t);
...
function zm(e, t, r) {
  ...
  if (n === "vue") {
    if (d.some((C4) => C4.type === "docType" && C4.value === "html" || C4.type === "element" && C4.name.toLowerCase() === "html"))
      return zm(
        e,
        Nm,
        r
  ...
  let f = a((w6) => {
    ...
    switch (w6.type) {
      case "element":
        f(w6);
        for (let D of w6.attrs)
          f(D), D.valueSpan ? (D.value = D.valueSpan.toString(), /["']/u.test(D.value[0]) && (D.value = D.value.slice(
            1,
            -1
          ))) : D.value = null;
        break;
    ...
    if (w6.type === "element" && (i && (!w6.namespace || w6.namespace === w6.tagDefinition.implicitNamespacePrefix || ya(w6)) && (w6.name = b(
      ...
      for (let D of w6.attrs)
        D.namespace || (D.name = b(D.name, (x5) => Zu.has(w6.name) && (Zu.get("*").has(x5) || Zu.get(
          w6.name
        ).has(x5))));
  }, "D"), g7 = a((w6) => {
...
var Vm = F2(() => {
  Tx = Object.defineProperty, Q5 = a((e) => {
    ...
    for (var r in t)
      Tx(e, r, { get: t[r], enumerable: true });
...
`);
    ...
    _consumeBlockStart(t) {
      ...
      if (this._cursor.peek() === 40)
        if (this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(ie), this._attemptCharCode(
          41
        ))
    ...
    _consumeLetDeclaration(t) {
      if (this._beginToken(30, t), _i(this._cursor.peek()))
        this._attemptCharCodeUntilFn(ie);
      else {
    ...
    _tokenizeExpansionForm() {
      ...
      if (XS(this._cursor.peek()) && this._isInExpansionForm())
    ...
    _endToken(t, r) {
      ...
      if (this._currentTokenType === null)
        throw new Xu("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
    ...
    handleError(t) {
      if (t instanceof Cc && (t = this._createError(t.msg, this._cursor.getSpan(t.cursor))), t instanceof Yu)
    ...
    _requireCharCode(t) {
      ...
      if (!this._attemptCharCode(t))
        throw this._createError(Dn(this._cursor.peek()), this._cursor.getSpan(r));
    }
    _attemptStr(t) {
      let r = t.length;
    ...
    _requireCharCodeUntilFn(t, r) {
      ...
      if (this._attemptCharCodeUntilFn(t), this._cursor.diff(n) < r)
        throw this._createError(Dn(this._cursor.peek()), this._cursor.getSpan(n));
    }
    _attemptUntilChar(t) {
    ...
    _consumeEntity(t) {
      ...
      if (this._cursor.advance(), this._attemptCharCode(35)) {
        ...
        let n = this._cursor.clone();
        if (this._attemptCharCodeUntilFn(GS), this._cursor.peek() != 59)
          ...
          let i = zi[o];
          if (!i)
            throw this._createError(V5(o), this._cursor.getSpan(r));
          this._endToken([i, `&${o};`]);
        }
      }
    }
    ...
    _consumeTagOpen(t) {
      let r, n, o, i = [];
      try {
        if (!Pi(this._cursor.peek()))
          throw this._createError(Dn(this._cursor.peek()), this._cursor.getSpan(t));
    ...
    _consumeAttributeName() {
      ...
      if (t === 39 || t === 34)
        throw this._createError(Dn(t), this._cursor.getSpan());
      this._beginToken(14);
      let r = this._consumePrefixAndName();
    ...
    _consumeTagClose(t) {
      if (this._beginToken(3, t), this._attemptCharCodeUntilFn(ie), this._allowHtmComponentClosingTags && this._attemptCharCode(47))
  ...
  $m = (rr = class {
    ...
    advanceState(t) {
      if (t.offset >= this.end)
        throw this.state = t, new Cc('Unexpected character "EOF"', this);
    ...
    processEscapeSequence() {
      ...
      if (t() === 92)
        if (this.internalState = { ...this.state }, this.advanceState(this.internalState), t() === 110)
          ...
          xc(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
    }
    decodeHexDigits(t, r) {
      let n = this.input.slice(t.internalState.offset, t.internalState.offset + r), o = parseInt(n, 16);
      if (isNaN(o))
        throw t.state = t.internalState, new Cc("Invalid hexadecimal escape sequence", t);
      return o;
    }
    ...
    build() {
      ...
      for (let t of this._containerStack)
        t instanceof yn && this.errors.push(Ae.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`));
    }
    _advance() {
      let t = this._peek;
    ...
    _parseExpansionCase() {
      ...
      if (this._peek.type !== 22)
        return this.errors.push(Ae.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
      ...
      for (; ; ) {
        if ((this._peek.type === 20 || this._peek.type === 22) && n.push(this._peek.type), this._peek.type === 23)
          if (X5(n, 22)) {
            ...
            return this.errors.push(Ae.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
        if (this._peek.type === 24)
          if (X5(n, 20))
            n.pop();
          else
...
`) {
    ...
    _consumeStartTag(t) {
      ...
      if (this._peek.type === 2) {
        ...
        this._peek.type === 1 && (this._advance(), l7 = false);
    ...
    _consumeEndTag(t) {
      ...
      if (r && this.getTagDefinition(r).isVoid)
        this.errors.push(Ae.create(r, t.sourceSpan, `Void elements do not have end tags "${t.parts[1]}"`));
    ...
    _popContainer(t, r, n) {
      ...
      for (let i = this._containerStack.length - 1; i >= 0; i--) {
        ...
        if (Ii(l7.name) ? l7.name === t : (t == null || l7.name.toLowerCase() === t.toLowerCase()) && l7 instanceof r)
          return l7.endSourceSpan = n, l7.sourceSpan.end = n !== null ? n.end : l7.sourceSpan.end, this._containerStack.splice(i, this._containerStack.length - i), !o;
    ...
    _consumeAttr(t) {
      ...
      if (this._peek.type === 16)
        for (u7 = this._peek.sourceSpan, c = this._peek.sourceSpan.end; this._peek.type === 16 || this._peek.type === 17 || this._peek.type === 9; ) {
          let d = this._advance();
    ...
    _getClosestParentElement() {
      for (let t = this._containerStack.length - 1; t > -1; t--)
        if (this._containerStack[t] instanceof tr)
  ...
  lR = iR, Ti = { attrs: true, children: true, cases: true, expression: true }, Z5 = /* @__PURE__ */ new Set(["parent"]), sR = (vt = class {
    constructor(t = {}) {
      for (let r of /* @__PURE__ */ new Set([...Z5, ...Object.keys(t)]))
...
function $R(e, t, r, n, o) {
  for (var i = [], l7; t; )
    i.push(t), l7 = t.previousComponent, delete t.previousComponent, t = l7;
  i.reverse();
  for (var u7 = 0, c = i.length, p = 0, d = 0; u7 < c; u7++) {
    ...
    if (h4.removed) {
      ...
      if (!h4.added && o) {
        ...
        h4.value = e.join(r.slice(p, p + h4.count));
...
function Lc(e, t, r, n, o) {
  ...
  if (NR.call(e) === "[object Array]") {
    for (t.push(e), l7 = new Array(e.length), r.push(l7), i = 0; i < e.length; i += 1)
      l7[i] = Lc(e[i], t, r, n, o);
  ...
  if (e && e.toJSON && (e = e.toJSON()), al(e) === "object" && e !== null) {
    ...
    var u7 = [], c;
    for (c in e)
      e.hasOwnProperty(c) && u7.push(c);
    for (u7.sort(), i = 0; i < u7.length; i += 1)
      c = u7[i], l7[c] = Lc(e[c], t, r, n, c);
    t.pop(), r.pop();
  } else
    l7 = e;
  return l7;
    ...
    if ((t == null ? void 0 : t(i)) !== false)
      switch (l7) {
        ...
        case xt: {
          ...
          for (let c = u7.length, p = c - 1; p >= 0; --p)
            o.push(u7[p]);
          break;
        }
        case Ne:
        ...
        case He:
          if (n && i.expandedStates)
            for (let u7 = i.expandedStates.length, c = u7 - 1; c >= 0; --c)
...
function iA(e) {
  ...
  function n(i, l7, u7) {
    ...
    if (i.type === Ke)
      return ((p = u7 == null ? void 0 : u7[l7 - 1]) == null ? void 0 : p.type) === ye && u7[l7 - 1].hard ? void 0 : "breakParent";
    if (i.type === $t)
      return "trim";
    if (i.type === Pt)
...
function hA(e) {
  if (e.type === He && e.break || e.type === ye && e.hard || e.type === Ke)
    return true;
}
function mA(e) {
...
function Xm(e) {
  for (e = [...e]; e.length >= 2 && he(false, e, -2).type === ye && he(false, e, -1).type === Ke; )
    e.length -= 2;
  if (e.length > 0) {
  ...
  for (; r >= 0; ) {
    ...
    switch (h4) {
      ...
      case xt: {
        ...
        for (let v6 = f.length - 1; v6 >= 0; v6--)
          u7.push({ mode: p, doc: f[v6] });
        break;
      }
      case Pt:
      case Ht:
          ...
          case Pe: {
            ...
            if (!b.break && ol(m, l7, g7, y, r))
              ...
              if (b.break) {
                ...
                for (let D = 1; D < b.expandedStates.length + 1; D++)
                  if (D >= b.expandedStates.length) {
                    l7.push({ ind: f, mode: Pe, doc: w6 });
                    break;
                  } else {
              ...
              l7.push({ ind: f, mode: Pe, doc: b.contents });
            break;
          }
        }
...
function OA(e, t) {
  let { comments: r } = e;
  if (delete e.comments, !PA(r) || !t.printer.canAttachComment)
    return;
  ...
  for (let [v6, b] of f.entries()) {
    ...
    let S7;
    if (l7 ? S7 = [b] : (m.enclosingNode = y, m.precedingNode = g7, m.followingNode = w6, S7 = [m, D, x5, C4, E7]), NA(D, x5, f, v6))
      m.placement = "ownLine", p(...S7) || (w6 ? no(w6, m) : g7 ? oo(g7, m) : Hr(y || C4, m));
    else if (jA(D, x5, f, v6))
      m.placement = "endOfLine", d(...S7) || (g7 ? oo(g7, m) : w6 ? no(w6, m) : Hr(y || C4, m));
    else if (m.placement = "remaining", !h4(...S7))
      if (g7 && w6) {
        let R = n.length;
        R > 0 && n[R - 1].followingNode !== w6 && Ym(n, x5), n.push(b);
      } else
        g7 ? oo(g7, m) : w6 ? no(w6, m) : Hr(y || C4, m);
  }
  if (Ym(n, t), !l7)
    for (let v6 of r)
      delete v6.precedingNode, delete v6.enclosingNode, delete v6.followingNode;
}
function NA(e, t, r, n) {
...
function Ym(e, t) {
  ...
  for (let [p, { comment: d }] of e.entries())
    p < c ? oo(i, d) : no(l7, d);
  for (let p of [i, l7])
    p.comments && p.comments.length > 1 && p.comments.sort((d, h4) => t.locStart(d) - t.locStart(h4));
  e.length = 0;
}
function Rc(e, t, r) {
...
function UA(e, t) {
  ...
  if ((r.comments || []).filter((u7) => !n.has(u7)).length === 0)
...
function G2({ plugins: e = [], showDeprecated: t = false } = {}) {
  ...
  for (let o of QA(Object.assign({}, ...e.map(({ options: i }) => i), ZA)))
    !t && o.deprecated || (Array.isArray(o.choices) && (t || (o.choices = o.choices.filter((i) => !i.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...JA(o.choices, r, e)])), o.pluginDefaults = Object.fromEntries(e.filter((i) => {
      var l7;
...
function iF(e, t) {
  ...
  for (; d < n; )
    r2[d] = e.charCodeAt(i + d), Ac[d] = ++d;
  for (; h4 < o; )
    for (l7 = t.charCodeAt(i + h4), c = h4++, u7 = h4, d = 0; d < n; d++)
      p = l7 === r2[d] ? c : c + 1, c = Ac[d], u7 = Ac[d] = c > u7 ? p > u7 ? u7 + 1 : p : p > c ? c + 1 : p;
  return u7;
}
function sF(e, t) {
  let r = new e(t), n = Object.create(r);
  for (let o of lF)
    o in t && (n[o] = uF(t[o], r, lr.prototype[o].length));
  return n;
}
function uF(e, t, r) {
...
function TF(e, { isCLI: t, FlagSchema: r }) {
  ...
  for (let o of e)
    n.push(IF(o, { isCLI: t, optionInfos: e, FlagSchema: r })), o.alias && t && n.push(cF.create({ name: o.alias, sourceName: o.name }));
  return n;
}
...
async function HF(e, t = {}) {
  ...
  if (!n.parser)
    if (n.filepath) {
      if (n.parser = nF(n, { physicalFile: n.filepath }), !n.parser)
        throw new Km(`No parser could be inferred for file "${n.filepath}".`);
    } else
      throw new Km("No parser and no file path given, couldn't infer a parser.");
  ...
  for (let [f, v6] of Object.entries(h4))
    (n[f] === null || n[f] === void 0) && (n[f] = v6);
...
async function NF(e, t, r, n, o) {
  ...
  v6();
  let h4 = e.stack;
  for (let { print: b, node: m, pathStack: g7 } of d)
    try {
      e.stack = g7;
  ...
  function v6() {
    let { node: b } = e;
    if (b === null || typeof b != "object" || u7(e))
      return;
    for (let g7 of p(b))
      Array.isArray(b[g7]) ? e.each(v6, g7) : e.call(v6, g7);
    let m = l7(e, r);
    if (m) {
...
function WF(e, t) {
  ...
  for (let c of TA(e, { getVisitorKeys: i, filter: l7 }))
    u7 = c;
  return u7;
}
function GF(e, t) {
  ...
  function l7(u7, c) {
    if (!(u7 !== null && typeof u7 == "object"))
      return u7;
    if (Array.isArray(u7))
      return u7.map((f) => l7(f, c)).filter(Boolean);
    let p = {}, d = new Set(o(u7));
    for (let f in u7)
      !Object.prototype.hasOwnProperty.call(u7, f) || i.has(f) || (d.has(f) ? p[f] = l7(u7[f], u7) : p[f] = u7[f]);
    let h4 = r(u7, p, c);
    if (h4 !== null)
      return h4 ?? p;
  }
...
function rk(e, t, r) {
  ...
  if (ZF(t)) {
    ...
    ({ startNode: h4, endNode: f } = QF(p, d, t));
...
async function ig(e, t, r = 0) {
  ...
  if (t.cursorOffset >= 0) {
    let c, p, d, h4, f;
    if (t.cursorNode && l7.cursorNodeText ? (c = t.locStart(t.cursorNode), p = o.slice(c, t.locEnd(t.cursorNode)), d = t.cursorOffset - c, h4 = l7.cursorNodeStart, f = l7.cursorNodeText) : (c = 0, p = o, d = t.cursorOffset, h4 = 0, f = l7.formatted), p === f)
      return {
...
async function sg(e, t) {
  ...
  if (o.rangeStart >= o.rangeEnd && n !== "" || o.requirePragma && !await g2(n, o))
...
function mk(e, t) {
  let r = null, n = t;
  for (; n !== r; )
    r = n, n = ir(e, n), n = Zc(e, n), n = Jc(e, n), n = Or(e, n);
  return n;
}
function gk(e, t) {
  let r = null, n = t;
  for (; n !== r; )
    r = n, n = O22(e, n), n = Zc(e, n), n = ir(e, n);
...
var hg = F2(() => {
  SR = Object.create, cl = Object.defineProperty, RR = Object.getOwnPropertyDescriptor, AR = Object.getOwnPropertyNames, FR = Object.getPrototypeOf, kR = Object.prototype.hasOwnProperty, v2 = a((e) => {
    ...
    for (var r in t)
      cl(e, r, { get: t[r], enumerable: true });
  }, "We"), w2 = a((e, t, r, n) => {
    if (t && typeof t == "object" || typeof t == "function")
      for (let o of AR(t))
        !kR.call(e, o) && o !== r && cl(e, o, { get: a(
          () => t[o],
          "get"
  ...
  MR = LR(() => {
    ...
    function o(m, g7) {
      ...
      for (var x5 in m)
        if (x5 !== "default" && {}.hasOwnProperty.call(m, x5)) {
    ...
    function f(m, g7, y) {
      ...
      if ($)
        ...
        S7 === A ? S7 ? M[E7] = [S7, 0] : M[E7] = true : M[E7] = [S7, A - S7];
 ...
 `, C4(x5.gutter, T.replace(/\d/g, " ")), " ", G, C4(x5.marker, "^").repeat(z)].join(""), U && y.message && (N += " " + C4(x5.message, y.message));
          ...
          return ` ${C4(x5.gutter, T)}${M.length > 0 ? ` ${M}` : ""}`;
      }).join(`
`);
...
${$}`), w6 ? D.reset($) : $;
  ...
  _t.prototype = { diff: a(function(e, t) {
    ...
    if (v6[0].oldPos + 1 >= c && b + 1 >= u7)
      return l7([{ value: this.join(t), count: t.length }]);
    var m = -1 / 0, g7 = 1 / 0;
    function y() {
      for (var D = Math.max(m, -p); D <= Math.min(g7, p); D += 2) {
        ...
        if (!A || S7 && C4.oldPos + 1 < E7.oldPos ? x5 = i.addToPath(E7, true, void 0, 0) : x5 = i.addToPath(C4, void 0, true, 1), b = i.extractCommon(
          ...
          e,
          D
        ), x5.oldPos + 1 >= c && b + 1 >= u7)
          return l7($R(i, x5.lastComponent, t, e, i.useLongestToken));
    ...
    for (var o = t.length, i = r.length, l7 = e.oldPos, u7 = l7 - n, c = 0; u7 + 1 < o && l7 + 1 < i && this.equals(t[u7 + 1], r[l7 + 1]); )
      u7++, l7++, c++;
  ...
  C2.tokenize = function(e) {
    for (var t = e.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/), r = 0; r < t.length - 1; r++)
      !t[r + 1] && t[r + 2] && qm.test(t[r]) && qm.test(
        t[r + 2]
  ...
  Gc = RA, AA = (so = class {
    ...
    each(t, ...r) {
      ...
      for (let l7 of r)
        i = i[l7], n.push(l7, i);
      try {
        for (let l7 = 0; l7 < i.length; ++l7)
          n.push(l7, i[l7]), t(this, l7, i), n.length -= 2;
      } finally {
        n.length = o;
      }
    }
    ...
    match(...t) {
      ...
      for (let i of t) {
        if (o === void 0)
          return false;
        let l7 = null;
        if (typeof n == "number" && (l7 = n, n = this.stack[r--], o = this.stack[r--]), i && !i(o, n, l7))
          return false;
    ...
    findAncestor(t) {
      for (let r of Aa(this, Pr, il).call(this))
        if (t(r))
          return r;
    }
    hasAncestor(t) {
...
in order for it to be formatted.`,
  ...
  nF = rF, ao = { key: a((e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), "key"), value(e) {
    ...
    if (Array.isArray(e))
      return `[${e.map((r) => ao.value(r)).join(", ")}]`;
    let t = Object.keys(e);
...
`)), K2(i, r.loggerPrintWidth);
  ...
  xF = (vo = class extends lr {
    ...
    _applyNormalization(t, r) {
      ...
      for (let l7 of o) {
        ...
        let p = a(({ from: f, to: v6 }) => {
          ...
          if (b !== false)
            if (b === true)
              this._hasDeprecationWarned(l7) || this._utils.logger.warn(this._deprecatedHandler(l7, v6, this._utils));
            else
        ...
        for (let { from: f, to: v6 } of h4.redirect)
          d({ value: f, redirectTo: v6 });
      }
      for (let l7 of i) {
        let u7 = t[l7];
    ...
    _applyUnknownHandler(t, r, n, o) {
      ...
      if (i)
        for (let l7 of Object.keys(i)) {
          if (this._identifyMissing(l7, i))
            continue;
          let u7 = i[l7];
    ...
    if (n) {
      let m = function(D) {
        ...
        if (document.activeElement === document.body)
          for (let C4 of D)
            C4.removedNodes.length > 0 && sr2(u7);
      };
...
//# sourceMappingURL=chunk-E2625MZG.js.map
